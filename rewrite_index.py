...
<head>
  ...
  <title>Wisemetrics — Documentation Hub</title>
  <meta name="description" content="Central de documentação de marca, produto e GTM da Wisemetrics." />
  ...
  <link rel="stylesheet" href="wisemetrics.css" />
  <script src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js"></script>
</head>
<body>
<div class="wm-app">
  <aside class="wm-side">
    <div class="wm-brandmark">
      <svg class="sym" viewBox="0 0 40 40" fill="none">
        <rect x="3" y="22" width="5" height="14" fill="currentColor" opacity=".85"/>
        <rect x="11" y="16" width="5" height="20" fill="currentColor" opacity=".85"/>
        <rect x="19" y="10" width="5" height="26" fill="currentColor" opacity=".85"/>
        <rect x="27" y="18" width="5" height="18" fill="currentColor" opacity=".85"/>
        <circle cx="34.5" cy="6" r="3.5" fill="var(--accent)"/>
      </svg>
      <div>
        <div class="name">Wisemetrics<span class="dot">.</span></div>
        <div class="wm-version">Hub de Documentação</div>
      </div>
    </div>
    <nav class="wm-nav">
  ...
  <main class="wm-main">
    <div class="wm-container" style="max-width: 1100px;">
      
      <section class="wm-hero">
        <div class="wm-hero-grid-overlay"></div>
        <canvas class="wm-hero-canvas" id="heroCanvas"></canvas>
        <div class="wm-hud">
          <div class="row"><span>sistema</span><span class="v">v1.0</span></div>
          <div class="row"><span>arquivos</span><span class="v">08 integrados</span></div>
          <div class="row"><span>última att.</span><span class="v">Abril 2026</span></div>
          <div class="row"><span>pontos</span><span class="v" data-k="p">3136</span></div>
        </div>
        <div class="wm-hero-content">
          <div class="wm-eyebrow wm-fade-up"><span class="pulse"></span>Documentation Suite</div>
          <h1 class="wm-h1 wm-fade-up d1">Estratégia, dados e produto <em>numa só lógica.</em></h1>
          <p class="wm-lede wm-fade-up d2">Bem-vindo ao centro de inteligência comercial e branding da Wisemetrics. Todo o racional estratégico, diretrizes visuais e posicionamento de mercado integrados em um único ecossistema.</p>
        </div>
      </section>
      ...
      <div class="wm-grid cols-2" style="margin-bottom: var(--wm-s-8);">
        ...
        <a href="go-to-market.html" class="wm-card" style="text-decoration:none; color:inherit;">
          <span class="kicker">04 · GROWTH</span>
          <h4>Go-to-Market</h4>
          <p>Planejamento estratégico de lançamento, OKRs por fase e cronograma de crescimento B2B.</p>
          <div style="display:flex; justify-content:flex-end; align-items:center; margin-top:auto;">
            <span class="wm-badge accent">ATIVO</span>
          </div>
        </a>
        ...
        <a href="wisemetrics-design-system-v2.html" class="wm-card" style="text-decoration:none; color:inherit; border-color: color-mix(in srgb, var(--accent) 30%, var(--border));">
          ...
          <div style="display:flex; justify-content:flex-end; align-items:center; margin-top:auto;">
            <span class="wm-badge primary">ROOT</span>
          </div>
        </a>
...
<script src="wisemetrics.js"></script>
</body>
</html>
"""
